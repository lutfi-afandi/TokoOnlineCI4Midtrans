...
<table class="table table-sm table-striped table-hover" style="width:100%">
    <tr>
        ...
        <td rowspan="3" style="vertical-align: middle; text-align: center; font-weight: bold; font-size: 25pt;" id="totalHarga">dfsdf
        </td><input type="hidden" name="faktur" id="faktur" value="<?= $nofaktur; ?>">
    </tr>
    <tr>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-1">
                ...
                <div class="input-group">
                    ...
                    <button style="display: none;" class="btn btn-sm btn-secondary" type="button" title="Reload Data" id="tombolReload">
